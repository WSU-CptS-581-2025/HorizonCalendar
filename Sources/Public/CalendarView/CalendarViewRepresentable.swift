...
@available(iOS 13.0, *)
public extension CalendarViewRepresentable {
    ...
    func layoutMargins(_ layoutMargins: NSDirectionalEdgeInsets) -> Self {
        var view = self
    ...
    func dayAspectRatio(_ dayAspectRatio: CGFloat) -> Self {
        var view = self
    ...
    func dayOfWeekAspectRatio(_ dayOfWeekAspectRatio: CGFloat) -> Self {
        var view = self
    ...
    func interMonthSpacing(_ interMonthSpacing: CGFloat) -> Self {
        var view = self
    ...
    func monthDayInsets(_ monthDayInsets: NSDirectionalEdgeInsets) -> Self {
        var view = self
    ...
    func verticalDayMargin(_ verticalDayMargin: CGFloat) -> Self {
        var view = self
    ...
    func horizontalDayMargin(_ horizontalDayMargin: CGFloat) -> Self {
        var view = self
    ...
    func daysOfTheWeekRowSeparator(
    ...
    func dayBackgroundItemProvider(
    ...
    func monthBackgroundItemProvider(
...
public extension CalendarViewRepresentable {
    ...
    func onDaySelection(_ daySelectionHandler: @escaping (Day) -> Void) -> Self {
        var view = self
    ...
    func onMultipleDaySelectionDrag(
...
extension CalendarViewRepresentable {
    ...
    private var minimumReasonableHeight: CGFloat {
        ...
        case let .horizontal(options):
            options.monthWidth(calendarWidth: minimumReasonableWidth, interMonthSpacing: 0)
        }
    }
