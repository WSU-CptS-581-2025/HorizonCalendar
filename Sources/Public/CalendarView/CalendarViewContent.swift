...
final class EmptyDayView: UIView, CalendarItemViewRepresentable {
    static func setContent(_: Content, on _: EmptyDayView) {}
    ...
    static func makeView(withInvariantViewProperties _: InvariantViewProperties) -> EmptyDayView {
        EmptyDayView()
    }

    func setContent(_: Content, animated _: Bool) {}
