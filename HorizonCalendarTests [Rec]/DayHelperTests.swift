...
final class DayHelperTests: XCTestCase {
  ...
  func testDayComparable() {
    ...
    let june0006Day = Day(
      month: MonthAlias(era: 0, year: 0006, month: 06, isInGregorianCalendar: true),
      day: 10)
    let january0005Day = Day(
      month: MonthAlias(era: 1, year: 0005, month: 01, isInGregorianCalendar: true),
      day: 09)
    XCTAssert(june0006Day < january0005Day, "Expected June 10, 0006 BCE < January 9, 0005 CE.")

    let june30Day = Day(
      month: MonthAlias(era: 235, year: 30, month: 06, isInGregorianCalendar: false),
      day: 25)
    let august01Day = Day(
      month: MonthAlias(era: 236, year: 01, month: 08, isInGregorianCalendar: false),
      day: 30)
  ...
  func testDayContainingDate() {
    ...
    let december0005Day = Day(
      month: MonthAlias(era: 0, year: 0005, month: 12, isInGregorianCalendar: true),
      day: 08)
    XCTAssert(
    ...
    let september02Day = Day(
      month: MonthAlias(era: 236, year: 02, month: 09, isInGregorianCalendar: false),
      day: 21)
    XCTAssert(
  ...
  func testStartDateOfDay() {
    let november2020Day = Day(
      month: MonthAlias(era: 1, year: 2020, month: 11, isInGregorianCalendar: true),
      day: 17)
    ...
    let january0100Day = Day(
      month: MonthAlias(era: 0, year: 0100, month: 01, isInGregorianCalendar: true),
      day: 14)
    ...
    let june02Day = Day(
      month: MonthAlias(era: 236, year: 02, month: 06, isInGregorianCalendar: false),
      day: 11)
  ...
  func testDayByAddingDays() {
    ...
    let april0069Day = Day(
      month: MonthAlias(era: 0, year: 0069, month: 04, isInGregorianCalendar: true),
      day: 20)
    let may0069Day = Day(
      month: MonthAlias(era: 0, year: 0069, month: 05, isInGregorianCalendar: true),
      day: 01)
    XCTAssert(
    ...
    let january02Day = Day(
      month: MonthAlias(era: 236, year: 02, month: 01, isInGregorianCalendar: false),
      day: 01)
    let december01Day = Day(
      month: MonthAlias(era: 236, year: 01, month: 12, isInGregorianCalendar: false),
      day: 31)
    XCTAssert(
